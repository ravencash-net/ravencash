...
"""Verify that starting ravencashd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ravencashd with -h for help text")
        ...
        self.log.info("Start ravencashd with -version for version information")
