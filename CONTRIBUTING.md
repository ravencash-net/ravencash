Contributing to RavenCash Core
============================

The RavenCash Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to ravencash-qt
...
[Translation Process](https://github.com/The-RavenCash-Endeavor/ravencash/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the RavenCash Core project (and related
projects such as libsecp256k1), and is not to be confused with overall RavenCash
Network Protocol consensus changes.

Whether a pull request is merged into RavenCash Core rests with the project merge
...
Patches that change RavenCash consensus rules are considerably more involved than
...
Where a patch set proposes to change the RavenCash consensus, it must have been
...
The review process is normally fairly responsive on the RavenCash Core repository, however
...
The project leader is the release manager for each RavenCash Core release.
