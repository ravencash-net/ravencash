...
This document provides guidelines for internationalization of the RavenCash Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ravencash_en.ts` remains unchanged.
