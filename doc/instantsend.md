...
This mechanism has been integrated into Bitcore-Node-RavenCash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ravencash/insight-api-ravencash#web-socket-api](https://github.com/ravencash/insight-api-ravencash#web-socket-api)
* API: [https://github.com/ravencash/insight-api-ravencash#instantsend-transactions](https://github.com/ravencash/insight-api-ravencash#instantsend-transactions)
