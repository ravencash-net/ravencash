...
* ravencash.conf: contains configuration settings for ravencashd or ravencash-qt
* ravencashd.pid: stores the process id of ravencashd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by ravencashd or ravencash-qt
