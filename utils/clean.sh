...
rm -f src/config/ravencash-config.h
...
rm -rf test_bitcoin.coverage/ ravencash-gtest.coverage/ total.coverage/
...
clean_exe src/ravencash-cli
clean_exe src/ravencashd
clean_exe src/ravencash-gtest
clean_exe src/ravencash-tx
clean_exe src/test/test_ravencash
clean_exe src/test/test_ravencash_fuzzy
...
clean_dep . src/config/ravencash-config.h.in
