...
#ifndef RAVENCASH_ARITH_UINT256_H
#define RAVENCASH_ARITH_UINT256_H
...
public:
     ...
     *
     * RavenCash only uses this "compact" format for encoding difficulty
...
#endif // RAVENCASH_ARITH_UINT256_H
