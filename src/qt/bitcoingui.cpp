...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RavenCash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ravencash: URIs)"));
    ...
    TransferAssetsAction->setStatusTip(tr("Transfer assets to RVH addresses"));
    ...
    aboutAction->setStatusTip(tr("Show information about RavenCash Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RavenCash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RavenCash addresses"));
    ...
    openAction->setStatusTip(tr("Open a ravencash: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible RavenCash command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::createToolBars()
{
    ...
    if(walletFrame)
    {
        ...
        // Add RavenCash logo on the right side
        QWidget* spacer = new QWidget();
        spacer->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
        toolbar->addWidget(spacer);

        QLabel *logoLabel = new QLabel();
        QPixmap logoPixmap(":/images/ravencash_logo_toolbar");
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to RavenCash network", "", count));
    } else {
...
{
    QString strTitle = tr("RavenCash Core"); // default title
    ...
    // Append title to "RavenCash Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
...
void BitcoinGUI::checkAssets()
{
    ...
    if(AreAssetsDeployed()) {
        ...
        TransferAssetsAction->setToolTip(tr("Transfer assets to RVH addresses"));
