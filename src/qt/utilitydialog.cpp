    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  ravencash-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the RavenCash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.1 RVH, 1 RVH, 10 RVH, 100 RVH and 1000 RVH -- sort of like the paper money you use every day.</li> \
