...
#ifndef RAVENCASHCOIN_ASSET_PROTOCOL_H
#define RAVENCASHCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_RAVENCASH_ASSET RVHQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_RAVENCASH_ASSET RVHO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_RAVENCASH_ASSET RVHR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_RAVENCASH_ASSET RVHT
...
#endif //RAVENCASHCOIN_ASSET_PROTOCOL_H
