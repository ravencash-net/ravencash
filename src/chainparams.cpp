...
public:
    CMainParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 1047200;
        ...
        consensus.defaultAssumeValid = uint256S("0x001cce6ebc4fbae6114b3d31d8ea4433362bf4fe721794611be47492156c2cee"); // genesisblock
        ...
        //FindMainNetGenesisBlock(1724169092, 0x20001fff, "main");
        uint32_t nGenesisTime = 1724169092;

        genesis = CreateGenesisBlock(nGenesisTime, 619, 0x20001fff, 4, 100 * COIN);
        uint256 mix_hash;
        ...
        assert(consensus.hashGenesisBlock == uint256S("001cce6ebc4fbae6114b3d31d8ea4433362bf4fe721794611be47492156c2cee"));
        ...
        checkpointData = {
            {  
                {0, uint256S("001cce6ebc4fbae6114b3d31d8ea4433362bf4fe721794611be47492156c2cee")}
            }
	    };

        chainTxData = ChainTxData{
            // Update as we know more about the contents of the RavenCash chain
        	1724169092, // * UNIX timestamp of last known number of transactions 2021-06-18 22:03:06 UTC
