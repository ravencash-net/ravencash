...
#error Client version information missing: version is not defined by ravencash-config.h or in any other way
#endif
...
/**
 * ravencashd-res.rc includes this file, but it cannot cope with real c++ code.
