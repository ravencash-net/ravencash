...
CAmount AmountFromValue(const UniValue& value, bool p_isRVH)
{
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "RavenCash Core server stopping";
}
...
{
    return "> ravencash-cli " + methodname + " " + args + "\n";
}
